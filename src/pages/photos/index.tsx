                ...
                <div className="relative">
                  <img
                    ...
                    style={{
                      filter: isEditing
                        ? filterType !== "none"
                          ? filters.find((f) => f.id === filterType)?.preview ||
                            ""
                          : ""
                        : "",
                    }}
                  ...
                  <div className="absolute top-0 right-0 p-2 sm:p-4 flex gap-2">
                    {isEditing ? (
                      ...
                      >
                        <Icon icon="lucide:check" className="text-xl mr-1" />
                        <span>Lưu</span>
                      </Button>
                    ) : (
                      <Button
                      ...
                      >
                        <Icon icon="lucide:edit-3" className="text-xl mr-1" />
                      ...
                      <div className="flex gap-2 overflow-x-auto pb-2 w-full justify-center">
                        {filters.map((filter) => (
                          <Button
                            key={filter.id}
                            color={
                              filterType === filter.id ? "primary" : "default"
                            }
                            variant="flat"
                            radius="full"
