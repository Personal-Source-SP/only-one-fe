        ...
        <Dropdown
            ...
            dropdownRender={() => (
                <div className="bg-slate-900/95 border border-slate-700 rounded-lg p-2 shadow-xl backdrop-blur-md min-w-[120px]">
                    <Typography.Text className="text-[10px] uppercase text-slate-500 font-bold px-2 mb-1 block">
                        Tốc độ phát
                    </Typography.Text>
...
export default VideoPlaybackSpeedMenu;
